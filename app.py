...
PERSIST_DIRECTORY = r"D:\Texas Tech\Texas Tech university\fall 2024\NS\Project_New_Try\group7_prototype\Q-A_Bot_NetworkSecurity-main\chroma_db"
PDF_FOLDER_PATH = r"D:\Texas Tech\Texas Tech university\fall 2024\NS\Project_New_Try\group7_prototype\Q-A_Bot_NetworkSecurity-main\pdfs"
...
def answer_query(query):
    try:
        ...
        if source_documents:
            ...
            page_number = source_metadata.get("page", "Unknown")
            source = f"{source_name} (Page {int(page_number) + 1})"
        else:
